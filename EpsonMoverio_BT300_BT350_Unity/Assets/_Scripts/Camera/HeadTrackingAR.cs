...
public class HeadTrackingAR : MonoBehaviour
{
	...
	{			
		...
		if (_gyroIsAvailable) 
		{
			...
			transform.Rotate(-Input.gyro.rotationRateUnbiased.x * 2.0f, -Input.gyro.rotationRateUnbiased.y * 2.0f, Mathf.Clamp(-Input.gyro.rotationRateUnbiased.z * 2.00f, -0.2f,.2f));
