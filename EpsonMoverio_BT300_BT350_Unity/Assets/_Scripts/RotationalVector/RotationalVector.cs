...
public class RotationalVector : MonoBehaviour 
{
	...
	void Update () 
	{
		if (toggle.isOn && MoverioController.Instance.MoverioDevice == true) //Taking the input from controller and rotating the cube along with the movement of the controller.
		{
